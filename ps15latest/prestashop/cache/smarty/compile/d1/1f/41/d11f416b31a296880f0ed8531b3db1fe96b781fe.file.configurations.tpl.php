<?php /* Smarty version Smarty-3.1.14, created on 2015-07-21 21:09:43
         compiled from "D:\OpenServer\domains\localhost\ps15latest\prestashop\modules\shopgate\views\templates\admin\configurations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1748755ae8ae76beb56-04947178%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd11f416b31a296880f0ed8531b3db1fe96b781fe' => 
    array (
      0 => 'D:\\OpenServer\\domains\\localhost\\ps15latest\\prestashop\\modules\\shopgate\\views\\templates\\admin\\configurations.tpl',
      1 => 1437502178,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1748755ae8ae76beb56-04947178',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55ae8ae7c8b2b9_02465700',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ae8ae7c8b2b9_02465700')) {function content_55ae8ae7c8b2b9_02465700($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\OpenServer\\domains\\localhost\\ps15latest\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>

<link rel='stylesheet' type='text/css' href='//fonts.googleapis.com/css?family=Open+Sans:400,600&subset=latin,latin-ext'/>
<link rel="stylesheet" type="text/css" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['mod_dir']->value, 'html', 'UTF-8');?>
...
<div id="shopgateTeaser">
    ...
    <div id="shopgateTeaserHeader">
        <div>
            <div class="logo">
                <img src="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['mod_dir']->value, 'html', 'UTF-8');?>
...
img/devices.png"/>
            ...
            <div class="register">
                <a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['offer_url']->value, 'html', 'UTF-8');?>
...
" frameborder="0" allowfullscreen></iframe>
        ...
        <div id="shopgateTeaserMain">
            ...
            <img class="contentImage" src="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['mod_dir']->value, 'html', 'UTF-8');?>
...
<form method="post" action="">
    <fieldset>
        <legend><img title="" alt="" src="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['mod_dir']->value, 'html', 'UTF-8');?>
img/logo.png"><?php echo smartyTranslate(array('s'=>'Configuration','mod'=>'shopgate'),$_smarty_tpl);?>
        ...
        <div class="margin-form">
            <input type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['api_url']->value, 'htmlall', 'UTF-8');?>
...
"
                            <?php if (strtoupper($_smarty_tpl->tpl_vars['currency']->value['iso_code'])==$_smarty_tpl->tpl_vars['configs']->value['currency']){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['currency']->value['name'], 'htmlall', 'UTF-8');?>
</option>
                <?php } ?>
            </select>
        </div>
        ...
        <div class="margin-form">
            <input type="text" name="configs[customer_number]" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['configs']->value['customer_number'], 'htmlall', 'UTF-8');?>
" size="4"/>
        </div>
        ...
        <div class="margin-form">
            <input type="text" name="configs[shop_number]" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['configs']->value['shop_number'], 'htmlall', 'UTF-8');?>
" size="4"/>
        </div>
        ...
        <div class="margin-form">
            <input type="text" name="configs[apikey]" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['configs']->value['apikey'], 'htmlall', 'UTF-8');?>
" size="20"/>
        </div>
...
?>
                    <option value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['key']->value, 'html', 'UTF-8');?>
"
                            <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['configs']->value['language']){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['name']->value, 'htmlall', 'UTF-8');?>
</option>
                <?php } ?>
            </select>
        </div>
...
?>
                    <option value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['key']->value, 'html', 'UTF-8');?>
"
                            <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['settings']->value['SHOPGATE_SHIPPING_SERVICE']){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['name']->value, 'htmlall', 'UTF-8');?>
</option>
                <?php } ?>
            </select>
        </div>
...
?>
                    <option value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['key']->value, 'html', 'UTF-8');?>
"
                            <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['configs']->value['server']){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['name']->value, 'htmlall', 'UTF-8');?>
</option>
                <?php } ?>
            </select>
        </div>
        <div id="shopgate_server" <?php if ($_smarty_tpl->tpl_vars['configs']->value['server']!='custom'){?>style="display:none;"<?php }?>>
            ...
            <div class="margin-form">
                <input type="text" name="configs[api_url]" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['configs']->value['api_url'], 'htmlall', 'UTF-8');?>
" size="40"/>
            </div>
        </div>
...
" src="../img/admin/disabled.gif"></label>
        ...
        <div class="margin-form">
            <input type="text" name="configs[alias]" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['configs']->value['alias'], 'htmlall', 'UTF-8');?>
" size="16"/>
        </div>
        ...
        <div class="margin-form">
            <input type="text" name="configs[cname]" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['configs']->value['cname'], 'htmlall', 'UTF-8');?>
" size="16"/>
        </div>
...
?>
                    <option value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['key']->value, 'html', 'UTF-8');?>
"
                            <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['settings']->value['SHOPGATE_PRODUCT_DESCRIPTION']){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['name']->value, 'htmlall', 'UTF-8');?>
</option>
                <?php } ?>
            </select>
        </div>
...
?>
                <label><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['carrier']->value['name'], 'htmlall', 'UTF-8');?>
</label>
                <div class="margin-form">
                    <select name="settings[<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['config_key']->value, 'html', 'UTF-8');?>
]">
                        <?php  $_smarty_tpl->tpl_vars['name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['name']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['shipping_service_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                            <option value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['key']->value, 'html', 'UTF-8');?>
"
                                    <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['settings']->value[$_smarty_tpl->tpl_vars['config_key']->value]){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['name']->value, 'htmlall', 'UTF-8');?>
</option>
                        <?php } ?>
                    </select>
                </div>
